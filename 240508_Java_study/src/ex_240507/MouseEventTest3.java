...
public class MouseEventTest3 extends JFrame {
	...
	public static void setLocationList(List<JLabel> labelList, Container c) {
	...
	// 반복되는 메서드, hashMap에서 꺼내서 위치 잡는 부분을 
		public static void setLocationList(List<JLabel> labelList,int x, int y) {
...
//	public MouseEventTest(JLabel jaJLabel, JLabel jaJLabel2) {
	public MouseEventTest3(List<JLabel> labelList) {
...
//		// 윈도우 창의 크기
	...
	public static void main(String[] args) {
		...
		MouseEventTest3 mouseEventTest = new MouseEventTest3(labelList);
